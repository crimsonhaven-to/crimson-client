...
import { Search, Play, HelpCircle, Film, Info, AlertTriangle, ChevronRight, Server, Hash, Menu, X, Heart, History, User, Coffee, Sparkles, RefreshCw } from 'lucide-react';
      ...
      <div className="space-y-8 text-sm sm:text-base text-crimson-100/70 leading-relaxed text-justify font-medium">
        ...
        <div className="bg-crimson-950/40 backdrop-blur-xl border border-crimson-900/50 p-6 sm:p-8 rounded-[2rem] font-mono text-xs text-crimson-400 space-y-3 shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
             ...
             <p className="flex items-center gap-2"><span className="text-crimson-600 font-black">STORAGE:</span> Local Cryptographic Identity</p>
             <p className="flex items-center gap-2"><span className="text-crimson-600 font-black">VERSION:</span> 2.4.0-STABLE</p>
          </div>
        </div>
