// The two ways in that need no Spotify connection: a public playlist's link,
// and a CSV export. With a connection, a pasted link goes through the Web API
// instead, which reads private playlists and every song.
